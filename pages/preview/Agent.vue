	...
	<view class="chat-container">
				...
				<view class="ai-msg-group">
					<view class="chat-bubble-ai card-shadow">
						<view class="result-header">
							...
							<text class="material-icons success">check_circle</text>
		...
		<view class="footer">
			<scroll-view scroll-x class="shortcut-scroll" show-scrollbar="false">
				...
				<view class="shortcut-item">
					<text class="material-icons warn">warning</text>
					<text>报告不适</text>
				</view>
				<view class="shortcut-item">
					<text class="material-icons info">description</text>
					<text>就医清单</text>
				</view>
			</scroll-view>

			<view class="input-row">
				<text class="material-icons add-icon">add_circle_outline</text>
				<view class="input-box">
					<input class="real-input" placeholder="输入健康疑问..." placeholder-class="ph" />
					<text class="material-icons mic-icon">mic</text>
				</view>
				<view class="send-btn">
					<text class="material-icons">arrow_upward</text>
				</view>
			</view>
...
.chat-main {
	flex: 1;
	.chat-content { padding: 40rpx 30rpx; }
}
...
.chart-header {
	...
	.live-tag { font-size: 18rpx; background: rgba(34, 197, 94, 0.1); color: #22c55e; padding: 4rpx 12rpx; border-radius: 8rpx; font-weight: 700; }
}
